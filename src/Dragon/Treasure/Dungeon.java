...
public class Dungeon {
    ...
    public static void playGame() {
        ...
        Player player = new Player(playerName, 1, 0, new Item[]{}); //skapar ny instans av Player och sötter första rummet till [0][1]
                    ...
                    for (int i=0; i < player.getBackpack().length;i++) {
                        Item item = player.getBackpack()[i]; //
                            if (item instanceof Weapon) {
                                ...
                                player.setDamage(player.getDamage() + weapon.getIncreaseDamage());
